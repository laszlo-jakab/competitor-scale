...
command <- c(
  ...
  paste0(
    "\\multicolumn{", nc, "}{p{.975\\textwidth}}{",
	  reg.performance$baseline$caption, "}\\\\\n \\addlinespace"))
add.to.row$command <- command

# print the table
print(
  xtable(reg.performance$baseline$results,
...
command <- c(
  # -1
  paste0("\\multicolumn{", nc, "}{p{.975\\textwidth}}{",
         reg.performance$liquidity$caption, "}\\\\\n \\addlinespace"),
  # 0
  "\\midrule \\\\\n",
  # 0
  paste0("\\multicolumn{", nc, "}{c}{\\textbf{Panel A: Fund Level Average Portfolio Liquidity}}\\\\\n"),
  # 0
  "\\midrule ",
  # 0
  ...
  "\\midrule \\\\\n",
  # rb
  paste0("\\multicolumn{", nc, "}{c}{\\textbf{Panel B: Real Time Portfolio Liquidity}} \\\\\n"),
  # rb
  "\\midrule ",
  # rb
   "$X=$ & $L$ & $S$ & $D$ & $C$ & $B$ \\\\\n",
...
# print the table
print(
  xtable(reg.performance$liquidity$results,
    align = paste(c("ll", rep("Y", (nc - 1))), collapse = ""),
...
command <- c(
  ...
  paste0(
    "\\multicolumn{", nc, "}{p{.975\\textwidth}}{",
	  reg.performance$baseline.08$caption, "}\\\\\n \\addlinespace"))
add.to.row$command <- command

# print the table
print(
  xtable(reg.performance$baseline.08$results,
    align = paste(c("ll", rep("Y", (nc - 1))), collapse = ""),
...
command <- c(
  ...
  paste0(
    "\\multicolumn{", nc, "}{p{.975\\textwidth}}{",
	  reg.performance$liquidity.08$caption, "}\\\\\n \\addlinespace"),
  # 0
  "\\midrule \\\\\n",
  # 0
  paste0(
    "\\multicolumn{", nc, "}{c}{\\textbf{Panel A: Fund Level Average Portfolio Liquidity}}\\\\\n"),
  # 0
  "\\midrule ",
  # 0
  "$\\bar{X}=$ & $\\bar{L}$ & $\\bar{S}$ & $\\bar{D}$ & $\\bar{C}$ & $\\bar{B}$ \\\\\n",
  ...
  # rb
  paste0(
    "\\multicolumn{", nc, "}{c}{\\textbf{Panel B: Real Time Portfolio Liquidity}} \\\\\n"),
  # rb
  "\\midrule ",
  # rb
   "$X=$ & $L$ & $S$ & $D$ & $C$ & $B$ \\\\\n",
...
# print the table
print(
  xtable(reg.performance$liquidity.08$results,
    align = paste(c("ll", rep("Y", (nc - 1))), collapse = ""),
