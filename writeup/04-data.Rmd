...
```{r histograms, echo = FALSE, fig.width = 6, fig.height = 3, dpi = 300, fig.align = 'center', fig.cap = paste(summary.figs$histograms$title, summary.figs$histograms$caption)}
