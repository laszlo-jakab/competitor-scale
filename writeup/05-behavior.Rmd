...
The results are consistent with managers reacting optimally to decreasing returns to own and competitor scale by scaling back active management. A one percent increase in competitor size is associated with a `r round(as.numeric(gsub("\\*+", "", reg.behavior$baseline$results[1, 2])) * 100)`bp change in active share, and a `r round(as.numeric(gsub("\\*+", "", reg.behavior$baseline$results[1, 3])) * 100)`bp change in the turnover to portfolio liquidity ratio. Increases in competitor scale are associated with statistically significant increases in each component of portfolio liquidity. A one percent increase in own size is associated with a `r round(as.numeric(gsub("\\*+", "", reg.behavior$baseline$results[3, 2])) * 100)`bp change in active share, and a `r round(as.numeric(gsub("\\*+", "", reg.behavior$baseline$results[3, 3])) * 100)`bp change in turnover to portfolio liquidity. 
