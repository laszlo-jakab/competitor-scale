...
`r min(AbsPC(tab.scandal$perf$sub.results$w1yr[1, 2:3]), AbsPC(tab.scandal$perf$sub.results$w1yr[1, 2:3]))`% to
`r max(AbsPC(tab.scandal$perf$sub.results$w1yr[1, 2:3]), AbsPC(tab.scandal$perf$sub.results$w1yr[1, 2:3]))`% 
(`r min(AbsPC(tab.scandal$perf$sub.results$w2yr[1, 2:3]), AbsPC(tab.scandal$perf$sub.results$w2yr[1, 2:3]))`% to
`r max(AbsPC(tab.scandal$perf$sub.results$w2yr[1, 2:3]), AbsPC(tab.scandal$perf$sub.results$w2yr[1, 2:3]))`%),
depending on specification. The corresponding difference in $ScandalOutFlow$ is associated with increases of
`r min(AbsPC(tab.scandal$perf$sub.results$w1yr[1, 4:5]), AbsPC(tab.scandal$perf$sub.results$w1yr[1, 4:5]))`% to
`r max(AbsPC(tab.scandal$perf$sub.results$w1yr[1, 4:5]), AbsPC(tab.scandal$perf$sub.results$w1yr[1, 4:5]))`% 
(`r min(AbsPC(tab.scandal$perf$sub.results$w2yr[1, 4:5]), AbsPC(tab.scandal$perf$sub.results$w2yr[1, 4:5]))`% to
`r max(AbsPC(tab.scandal$perf$sub.results$w2yr[1, 4:5]), AbsPC(tab.scandal$perf$sub.results$w2yr[1, 4:5]))`%).
